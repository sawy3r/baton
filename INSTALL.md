...
```text
Install Baton v1.0.0-rc.15.3 from
...
Do not install RC15.3 over files owned by RC2 through RC15.2. Use the exact
immutable release's own safe uninstall, including its preview and approval
flow. Only after that exact uninstall completes may the agent preview RC15.3.
