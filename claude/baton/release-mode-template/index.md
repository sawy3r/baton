...
release_worktree_path: # <set by first /implement-slice in the release — absolute path, e.g. <HOME>/projects/<repo-basename>-worktrees/release-2026-05-16-expenses-ia>
...
| File / surface | T1 | T2 |
|---|---|---|
| `apps/web/.../SomeComponent.tsx` | ✓ | |
| `apps/web/.../OtherComponent.tsx` | | ✓ |
