...
>
> **Naming convention:** `<release-name>` follows `YYYY-MM-DD-<theme>` where the date is planning-start (today). Examples: `2026-05-16-expenses-ia`, `2026-06-10-multi-currency`. See `role-prompts/planner.md` for rationale.
...
- **Related captures**: <links to prior session captures under `docs/captures/` (and historical `docs/superpowers/captures/` if relevant)>
