...
Slice: S01-deferred-payment-validation
Reason: spec.md assumes users[].deferredBalance exists in CheckoutValidationState but the field
...
SLICE: S01-deferred-payment-validation
NEXT: NONE
REASON: Data plumbing prerequisite missing from spec — deferredBalance not present in CheckoutValidationState.
-->
```
